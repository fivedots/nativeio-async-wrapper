...
var wasmBinaryFile = 'wrapped.wasm';
...
var ASM_CONSTS = {
  1034: function($0) {console.log("Open returned file descriptor number", $0 )},  
 1095: function() {console.log("Writing 10 bytes (value 1) at offset 4")},  
 1152: function($0) {console.log($0 + " bytes were written")},  
 1194: function() {console.log("Reading 6 bytes at offset 0")},  
 1239: function($0) {console.log($0 + " bytes were read. Contents:")},  
 1289: function($0) {console.log("	", $0)},  
 1315: function($0) {console.log("Close returned", $0 )},  
 1352: function($0) {console.log("GetAll returned (length:", $0+"):" )},  
 1404: function($0) {console.log("	", UTF8ToString($0))},  
 1444: function($0) {console.log("Delete returned", $0 )}
};
...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=6016;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        var pthreadMainJs = locateFile('wrapped.worker.js');
  ...
  var NativeIOWrapper={lastFileDescriptor:100,fileDescriptorToFileHandle:{},open:function(name) {
  ...
  function runAndAbortIfError(func) {
      try {
        ...
        var ASYNCIFY_IMPORTS = ["env.NativeIO_Open","env.NativeIO_Delete","env.NativeIO_GetAll","env.NativeIO_Read","env.NativeIO_Write","env.NativeIO_Close","env.invoke_*","env.__call_main","env.emscripten_sleep","env.emscripten_wget","env.emscripten_wget_data","env.emscripten_idb_load","env.emscripten_idb_store","env.emscripten_idb_delete","env.emscripten_idb_exists","env.emscripten_idb_load_blob","env.emscripten_idb_store_blob","env.SDL_Delay","env.emscripten_scan_registers","env.emscripten_lazy_load_code","env.emscripten_fiber_swap","wasi_snapshot_preview1.fd_sync","env.__wasi_fd_sync"].map(function(x) {
          return x.split('.')[1];
        });
      ...
      }};function _NativeIO_Close(fileDescriptor) {
  ...
  function _NativeIO_Delete(name_ptr) {
  ...
  function _NativeIO_GetAll(resultLength_ptr) {
      return Asyncify.handleSleep(function(wakeUp) {
  ...
  function _NativeIO_Open(name_ptr) {
      var name = UTF8ToString(name_ptr);
      return Asyncify.handleSleep(function(wakeUp) {
  ...
  function _NativeIO_Read(fileDescriptor, buffer_ptr, length, offset) {
  ...
  function _NativeIO_Write(fileDescriptor, buffer_ptr, length, offset) {
      //TODO
      return Asyncify.handleSleep(function(wakeUp) {
        var buffer = Module.HEAP8.subarray(buffer_ptr, buffer_ptr + length);
...
if (!Object.getOwnPropertyDescriptor(Module, "NativeIOWrapper")) Module["NativeIOWrapper"] = function() { abort("'NativeIOWrapper' was not exported. add it to EXTRA_EXPORTED_RUNTIME_METHODS (see the FAQ)") };
